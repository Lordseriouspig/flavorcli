...
Thanks for choosing StarCLI!
There are many different ways to install StarCLI. Choose the one that is the easiest or most convenient to you.

## GitHub Releases
If you wish to download a pre-compiled version from GitHub releases, please follow the following steps:
1. Go to https://github.com/Lordseriouspig/starcli/releases/latest
...
## Package Managers
StarCLI is on a few package managers. These can be convenient if you already have them installed, and make for easy management of your packages.

### [Crates.io (Cargo)](https://crates.io/crates/starcli)
...
2. Run ``cargo uninstall starcli``

### [AUR](https://aur.archlinux.org/packages/starcli/)
1. Ensure you have an AUR helper installed, such as yay.
2. Run ``yay -S starcli``
3. Profit!

#### Uninstall
1. Ensure you still have your AUR helper installed. (why wouldn't you..?)
2. Run ``yay -Rns starcli``

## Compile from source (not recommended)
You have two options if you wish to install StarCLI from source.
...
2. Run ``git clone https://github.com/Lordseriouspig/starcli``
...
1. Ensure you have git installed.
2. Run ``git clone -b development https://github.com/Lordseriouspig/starcli``
3. Ensure you have cargo installed. Follow the instructions [here](https://doc.rust-lang.org/cargo/getting-started/installation.html) if you do not.
4. Run ``cargo build --release``
