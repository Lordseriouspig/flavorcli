...
If you want to be able to use StarCLI anywhere by typing ``star``, you must add StarCLI to PATH. There are two ways to do this.

## Using the install script.
The install script will move StarCLI to a new directory and add it to PATH. This is the easiest way to do so, and all you need to do is download the script and execute it in the same directory that you have the program in. The ZIP file you download comes with the script along with it.
