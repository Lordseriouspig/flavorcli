...
## Usage
```bash
star devlog list [Options] [PROJECT_ID]
```
...
```bash
star devlog list 333
```
**Returns** (concatenated)
```
Devlogs for project: 'StarCLI'
╭───────┬────────────────────────────────────────────────────┬──────────┬───────┬──────────┬──────────────────╮
...
```bash
star devlog list 333 --fields id,body,duration
```
**Returns** (concatenated)
```
Devlogs for project: 'StarCLI'
