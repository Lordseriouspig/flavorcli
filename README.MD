...
[![Licence](https://img.shields.io/github/license/lordseriouspig/starcli)](https://www.gnu.org/licenses/gpl-3.0.en.html "GNU GPL 3.0")
[![Tracked on Hackatime](https://hackatime-badge.hackclub.com/U096NGLTF4K/starcli)](https://hackatime.hackclub.com/ "Go to Hackatime homepage")
[![Commit activity](https://img.shields.io/github/commit-activity/w/lordseriouspig/starcli)](https://github.com/Lordseriouspig/starcli/commits/main/ "Commit History")
[![Last Commit](https://img.shields.io/github/last-commit/lordseriouspig/starcli)](https://github.com/Lordseriouspig/starcli/commits/main/ "Commit History")
[![rust-clippy analyze](https://github.com/Lordseriouspig/starcli/actions/workflows/rust-clippy.yml/badge.svg)](https://github.com/Lordseriouspig/starcli/actions/workflows/rust-clippy.yml)

StarCLI is a fully-featured implementation of the Stardance API, allowing for easier and streamlined interaction with HackClub's Stardance.

# Full Documentation
The full documentation is available on [GitBook](https://starcli.gitbook.io/starcli-docs/) or in the [Docs Folder](/docs/). I've intentionally written these as more beginner friendly and less silly than this README.
...
At some point, StarCLI will be available on all[^1] major package managers.
#### GitHub Releases
...
4. (Optional) Execute the installer script.
   ...
   4. This will move the binary to a bin directory and add it to PATH, so you can type ``star`` to run the app at any time.
5. Keep the uninstall script handy for once stardance ends.
[^1]: What that constitutes is unknown to me, *I'll figure it out when it's time™*

#### Cargo
If you have cargo, you may choose to install StarCLI with the following command:
```
cargo install starcli
```
...
## Usage
### Get your API key
1. To get your Stardance API key, go to https://stardance.hackclub.com/kitchen and do all the things to get yourself signed in.
2. Click the gear icon in the toolbar to open your settings
   
![An image with a bunch of arrows pointing to a gear icon that you can find in the sidebar on the stardance website where you see your nameplate.](https://hc-cdn.hel1.your-objectstorage.com/s/v3/2578e86dd1cf0aa8_image.png)
...
4. StarCLI no longer requires you to get your user ID! Having said that, if you do wish to use the ``--no-verify`` tag when setting your auth, you *do* still need to add your user ID. You may also choose to override the user ID linked to your token for some reason.
